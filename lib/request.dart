...
class Request_Manager extends StatefulWidget {
  @override
  _Request_ManagerState createState() => _Request_ManagerState();
}

class _Request_ManagerState extends State<Request_Manager> {
  Alice _alice;
  Dio _dio;
